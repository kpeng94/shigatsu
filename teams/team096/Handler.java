...
public class Handler {
	...
	public static final int NEXT_TARGET_Y_CHANNEL = 14;
	public static final int NEXT_GUARD_X_CHANNEL = 15;
	public static final int NEXT_GUARD_Y_CHANNEL = 16;

	public static final int INTERWAVE_TIME = 800;
