...
//		checkMinerFrontier();
		...
		if (Count.getCountAtRallyPoint(Comm.getLauncherId(), currentLauncherWave) >= ULauncherHandler.LAUNCHER_RUSH_COUNT) { // Update launcher waves
			currentLauncherWave++;
...
//		}
		if (Count.getCount(Comm.getMinerfactId()) == 1) { // 1 mining fact
			Count.setLimit(Comm.getBeaverId(), 2);
